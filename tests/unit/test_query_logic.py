import pytest
from app.logic.query_logic import query_rag
from unittest.mock import patch, MagicMock

def test_query_rag_basic():
    """Test basic RAG query functionality"""
    with patch('app.logic.query_logic.ChatOpenAI') as mock_chat:
...
async def test_query_rag_with_context():
    ...
    with patch('app.logic.query_logic.Chroma') as mock_chroma:
